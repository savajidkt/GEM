...
if ( ! function_exists( 'get_wmsc_steps' ) ) {
	...
	function get_wmsc_steps() {
		...
		$steps = array(
			'your-details'  => array(
				'title'    => __( 'Your Details', 'wp-multi-step-checkout' ),
				'position' => 10,
				'class'    => 'wpmc-step-your-details',
				'sections' => array( 'your_details' ),
			),
			'billing'  => array(
...
if ( ! function_exists( 'wmsc_step_content_login' ) ) {
	...
	<div class="wpmc-step-item wpmc-step-login" style="display:block;">
...
if ( ! function_exists( 'wmsc_step_content_your_details' ) ) {

	/**
	 * The content of the Billing step.
	 */
	function wmsc_step_content_your_details() {
