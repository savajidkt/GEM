	...
	public function create_admin_notice() {
		...
		$setting_url = add_query_arg(
			array(
				'page'    => 'wc-settings',
				'tab'     => 'products',
				'section' => 'woocommerce-product-filters',
			),
			admin_url( 'admin.php' )
		);
		...
		\WC_Admin_Notices::add_custom_notice(
			'wcpf_activation',
			'<p>
                <strong>' . __( 'Product Filter for WooCommerce Installed', 'woocommerce-product-filters' ) . '</strong> <span> - ' . __( 'Now you\'re ready to edit filters', 'woocommerce-product-filters' ) . '</span>
            </p>
            <p class="submit">
                <a href="' . esc_attr( $list_projects_url ) . '" class="button button-primary">' . __( 'Edit Filters', 'woocommerce-product-filters' ) . '</a> <a href="' . esc_attr( $setting_url ) . '" class="button button-primary">' . __( 'Settings', 'woocommerce-product-filters' ) . '</a>
            </p>'
		);
	}
		...
		return array(
			...
			'childEntities' => array(
				...
				array(
					'entityId'  => 'virtual-3',
					'parentId'  => 'virtual-1',
					'title'     => __( 'Tags', 'woocommerce-product-filters' ),
