<?php
	$clear_button = addslashes( '<a href="' . esc_url( $tool_link ) . '" target="_blank" class="wcpf-clear-cache-button add-new-h2">' . esc_html__( 'Clear Cache', 'woocommerce-product-filters' ) . '</a>' );
?>
