	...
	<div class="control-content">
		<div class="control-image-container">
			...
			<div class="upload-container">
				<span class="empty-text"><?php echo esc_html__( 'No image selected', 'woocommerce-product-filters' ); ?> </span>
				<button class="button upload-image">
					<span class="text"><?php echo esc_html__( 'Add Image', 'woocommerce-product-filters' ); ?></span>
				</button>
			</div>
		</div>
