...
<div class="wrap clearfix woocommerce-product-filter-manage-project-wrapper">
	<h1 class="wp-heading-inline">
		<?php echo esc_html__( 'Edit Project', 'woocommerce-product-filters' ); ?>
					...
					<div class="page-editor-container">
						<div class="panel editor-panel">
							<div class="postbox panel projections-panel">
								<h2 class="hndle">
									<span class="title"><?php echo esc_html__( 'Elements', 'woocommerce-product-filters' ); ?></span>
								...
								<div class="inside">
									<div class="projections-zone empty-state">
										<div class="default-projections-zone-text">
											<span class="text"><?php echo esc_html__( 'Project does not have elements', 'woocommerce-product-filters' ); ?></span>
										</div>
										<div class="projections-container"></div>
									</div>
									<div class="navigation">
										<button class="button button-primary save-project"><?php echo esc_html__( 'Save', 'woocommerce-product-filters' ); ?></button>
										<button class="button add-element"><?php echo esc_html__( 'Add Element', 'woocommerce-product-filters' ); ?></button>
									</div>
								</div>
							</div>
