<?php
	...
	$price_text = apply_filters( 'wcpf_translate', __( 'Price', 'woocommerce-product-filters' ) );
	?>
			...
			<div class="priceSliderAmount">
				<div class="wcpf-price-slider-min-max-inputs">
					<input type="text"
						...
						placeholder="<?php echo esc_attr( __( 'Min price', 'woocommerce-product-filters' ) ); ?>" />
					<input type="text"
						...
						placeholder="<?php echo esc_attr( __( 'Max price', 'woocommerce-product-filters' ) ); ?>" />
				</div>
