...
class Survey_Maker_Admin {
    ...
    public function add_plugin_admin_menu(){
        ...
        $menu_item = ($unread_results_count == 0) ? 'Questionnaires' : 'Questionnaires' . '<span class="ays-survey-menu-badge ays-survey-results-bage">' . $unread_results_count . '</span>';
    ...
    public function add_plugin_surveys_submenu(){
        $hook_survey_maker = add_submenu_page(
            $this->plugin_name,
            __('Questionnaires', "survey-maker"),
            __('Questionnaires', "survey-maker"),
            $this->capability,
            $this->plugin_name,
            array($this, 'display_plugin_surveys_page')
    ...
    public function add_plugin_survey_categories_submenu(){
        $hook_survey_categories = add_submenu_page(
            $this->plugin_name,
            __('Questionnaire Categories', "survey-maker"),
            __('Questionnaire Categories', "survey-maker"),
            $this->capability,
    ...
    public function add_plugin_popup_survey(){
        $hook_popup = add_submenu_page( $this->plugin_name,
            __('Popup Questionnaire', "survey-maker"),
            __('Popup Questionnaire', "survey-maker"),
            $this->capability,
