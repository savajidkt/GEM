        ...
        if($unique_id === null){
            ...
            if($survey_id === null){
                ...
                $message_data = array(
                    ...
                    'user_name'          => $userArr->data->user_login,
                    'user_email'         => $userArr->data->user_email,
                    'user_wordpress_email' => $user_wordpress_email,
                    'user_id'            => $userArr->data->ID,
                ...
                $send_data = array(
                    ...
                    'event_pro_id' => $data['event_pro_id'],
                    'title' => $data['title'],
                    'your_name' => $data['your_name'],
                    'company' => $data['your_company_name'],
                    'job_title' => $data['your_job_title'],
                    'mobile' => $data['your_mobile_number'],
        ...
        */
    	...
    	$content[] = '<div class="' . $this->html_class_prefix . 'container ' . $blocked_content_class . $this->options[ $this->name_prefix . 'custom_class' ] . '" id="' . $this->html_class_prefix . 'container-' . $this->unique_id_in_class . '" data-id="' . $unique_id . '">';
            if($this->options[ $this->name_prefix . 'enable_survey_start_loader' ] && !Survey_Maker_Data::ays_survey_is_elementor()){
                $content[]  = '<div class="lds-ellipsis ' . $this->html_class_prefix . 'wait-loading-loader" data-class="lds-ellipsis" data-role="loader" class="ays-loader"><div></div><div></div><div></div><div></div></div>';
            }
                ...
                if( $show_section_header ){
                    ...
                    //$content[] = '<div class="' . $this->html_class_prefix . 'section-title-row">';
                           // $content[] = '<div class="' . $this->html_class_prefix . 'section-title-row-main">';
                               // $content[] = '<span class="aaaa ' . $this->html_class_prefix . 'section-title">' . stripslashes( $section['title'] ) . '</span>';
                           // $content[] = '</div>';
                   // $content[] = '</div>';
