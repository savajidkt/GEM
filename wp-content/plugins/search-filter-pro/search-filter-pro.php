...
update_option('search_filter_license_key', '8f93cd515246450592289a2689e6ec00');
update_option('search_filter_license_expires', '1-1-2050');
...
if ( ! defined( 'SEARCH_FILTER_VERSION' ) ) {
	define('SEARCH_FILTER_VERSION', "2.5.8");
}
