...
(function ( $ ) {
	...
	$(function () {
		...
		$(document).on("click", ".search-filter-reset", function(e){
			...
			var $all_options = $('#search-filter-form-'+searchFormID+' .sf-field-taxonomy-resource-category').find('li');
				$all_options.find('input:checked').removeAttr('checked')
				$all_options.removeClass("sf-option-active");
				
				var resourceType = $('.resource-type .sf-option-active').find('input');
				var rTypeName ='';
				 rTypeName = resourceType[0].value;
				$(".sf-field-taxonomy-resource-type input[value='" + rTypeName + "']").prop('checked', true);
				$(".resource-type input[value='" + rTypeName + "']").trigger('click');

				$('#xclearFaq, #xclearResourceCentre').addClass('hide');
        ...
        this.attachActiveClass = function(){
            ...
            {	
                ...
                if((this_tag=="input")&&((input_type=="radio")||(input_type=="checkbox")) && (parent_tag=="li"))
                {
                    ...
                    var clickType = $all_options_fields[0].value;
                    $all_options.removeClass("sf-option-active");
                    ...
                    console.log($all_options_fields[0].value);

					
					if($all_options_fields[0].name == "_sft_faq-category[]" && $all_options_fields.length > 0){						
						$('#xclearFaq').removeClass('hide');						
					} else {	
						if($all_options_fields[0].name != ""){											
						$('#xclearFaq').addClass('hide');
						}	
					}


					if($all_options_fields[0].name == "_sft_resource-category[]" && $all_options_fields.length > 0){						
						$('#xclearResourceCentre').removeClass('hide');						
					} else {					
						if($all_options_fields[0].name != ""){											
						$('#xclearResourceCentre').addClass('hide');
						}
                    ...
                    $(".sf-field-taxonomy-resource-type input[value='" + clickType + "']").attr('checked', 'checked');

                    $(".sf-field-taxonomy-resource-type input[value='webinar-recordings']").removeAttr('checked');
                    $(".sf-field-taxonomy-resource-type input[value='downloads']").removeAttr('checked');	

					//$('#xclearResourceCentre').removeClass('hide');	

                    }else if(clickType == 'webinar-recordings'){

                    	$(".sf-field-taxonomy-resource-type input[value='" + clickType + "']").attr('checked', 'checked');
                    	$(".sf-field-taxonomy-resource-type input[value='blog']").removeAttr('checked');
                    	$(".sf-field-taxonomy-resource-type input[value='downloads']").removeAttr('checked');
						//$('#xclearResourceCentre').removeClass('hide');	
                    }else if(clickType == 'downloads'){
					...
					$(".sf-field-taxonomy-resource-type input[value='" + clickType + "']").prop('checked', true);
                    // var $all_options1 = $(".sf-field-taxonomy-resource-type , .sf-field-taxonomy-faq-type").find('li');
                    // 	$all_options1.removeClass("sf-option-active");

                    $(".sf-field-taxonomy-resource-type input[value='" + clickType + "'] , .sf-field-taxonomy-faq-type input[value='" + clickType + "']").parent().addClass('sf-option-active');
                    
                    if(clickType == 'about'){
					

                    $(".sf-field-taxonomy-faq-type input[value='" + clickType + "']").attr('checked', 'checked');

                    $(".sf-field-taxonomy-faq-type input[value='conferences']").removeAttr('checked');
                    $(".sf-field-taxonomy-faq-type input[value='poster-presentation']").removeAttr('checked');
                    	

                    }else if(clickType == 'conferences'){

						$('#xclearFaq').removeClass('hide');
                    	$(".sf-field-taxonomy-faq-type input[value='" + clickType + "']").attr('checked', 'checked');
                    	$(".sf-field-taxonomy-faq-type input[value='about']").removeAttr('checked');
                    	$(".sf-field-taxonomy-faq-type input[value='poster-presentation']").removeAttr('checked');
                    	
                    }else if(clickType == 'poster-presentation'){
						$('#xclearFaq').removeClass('hide');
                    	$(".sf-field-taxonomy-faq-type input[value='" + clickType + "']").attr('checked', 'checked');
                    	$(".sf-field-taxonomy-faq-type input[value='conferences']").removeAttr('checked');
                    	$(".sf-field-taxonomy-faq-type input[value='about']").removeAttr('checked');
