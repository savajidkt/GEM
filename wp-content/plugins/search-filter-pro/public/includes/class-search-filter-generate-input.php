...
class Search_Filter_Generate_Input {
...

	{
		...
		$input_args['attributes']['class'] = "childClsUl";
		...
		<ul<?php echo $attibutes_html; ?>>
...

			{
				...
				echo '<li class="'.$option_class.' childClsLi"'.$container_attibutes_html.'><input '.$input_attibutes_html.'><label class="sf-label-checkbox" for="'.$input_id.'">'.$option_label.'</label>';
