...
class Search_Filter_Display_Shortcode {
...

            {
...

                {
...

                    {
                        ...
                        $returnvar .= "<ul class='accordionUL'>";
...

    {
        ...
        $returnvar .= "<li class=\"$field_class accordionLI\" data-sf-field-name=\"$field_name\" data-sf-field-type=\"".$field_data['type']."\" data-sf-field-input-type=\"".$input_type."\"".$addAttributes.">";
...

        {
...

            {
                ...
                $returnvar .= "<input type=\"checkbox\" class=\"checkInput\" checked>";
                $returnvar .= "<i></i>";                
