...
<section id="checkout">
  ...
  <div class="tab_container">
    ...
    <form name="checkout" id="checkout-frm" method="post" class="checkout woocommerce-checkout"
          ...
          <div class="checkout">
            <div class="checkout_form">
              ...
              <div class="order_summary">
                ...
                <div class="pay_all">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/Group 2659.png" alt="" />
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/Group 2660.png" alt="" />
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/Group 2661.png" alt="" />
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/Group 2662.png" alt="" />
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/Group 2663.png" alt="" />
                  <img src="<?php echo get_template_directory_uri(); ?>/assets//google-pay-mark_800.png" alt="" />
                </div>
              </div>
              <!-- right side card  end-->
          ...
          <div class="checkout_form">
            ...
            <div class="billing_info">
              ...
              <div class="checkout_bill_common promotion">
                ...
                <div class="common_input address_detail">
                  <input placeholder="NEWBIE10" type="text" name="coupon" id="coupon" />
                  <button type="button" id="apply" class="common_btn_primary_custom">Apply</button>
                </div>
              </div>
              <?php }else{?>
              <div class="checkout_bill_common promotion">
                ...
                <div class="common_input address_detail">
                  <input placeholder="NEWBIE10" type="text" readonly
                    value="<?php echo esc_attr( sanitize_title( $code ) ); ?>" />
        ...
        <div id="tab_3">
          <div class="checkout_form">
            ...
            <?php if (!is_user_logged_in() ) {?>
              ...
              <span class="desc">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
      ...
      <div class="grp_btn">
        ...
        <button type="button" id="nextBtn" data-step="0" class="normalbtn">Proceed to payment</button>
        <button type="submit" id="nextBtn" class="submitbtn hide">Proceed to payment</button>
      </div>
      <?php if ( is_user_logged_in() ) {?>
    </form>
    <?php } ?>
