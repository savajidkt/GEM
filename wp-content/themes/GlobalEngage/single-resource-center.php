            ...
            <div class="single_resource-page-rt">
                ...
                if(is_array($webinar_videoArr) && count($webinar_videoArr) > 0){
                    ...
                    foreach ($webinar_videoArr as $key => $value) {
                        ...
                        } else if($value['video_type'] == 'External' && strlen($value['external_video']['url']) > 0){
                      
                            ?>
                            
                            <section class="video-hal" id="desktop_video">
                                    <div class="container">
                                        <div class="video-wrapper">
                                        <video controls width="250" poster=
"<?php echo $value['desktop_thumbnail']; ?>">
    

    <source src="<?php echo $value['external_video']['url'];?>" type="video/mp4">
                                ...
                                <section class="video-hal" id="mobile_video">
                                    <div class="container">
                                        <div class="video-wrapper">
                                        <video controls width="250" poster=
"<?php echo $value['mobile_thumbnail']; ?>">
...
<?php } else if(isset($term_obj_list[0]->slug) && $term_obj_list[0]->slug == "blog") {  ?>
    ...
    <?php if(isset($term_obj_list[0]->slug) && $term_obj_list[0]->slug == "blog") { ?>
<section>
    <div class="container">
...
$result = getContactFormData($form);

if(isset($term_obj_list[0]->slug) && $term_obj_list[0]->slug == "webinar-recordings" && get_field('popup_form') != 'noform' && !$result) { ?>
