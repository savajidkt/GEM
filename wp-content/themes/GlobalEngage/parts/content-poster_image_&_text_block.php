...
?>
<section class="featured_event_slider smb-section" id="poster_presentation" <?php if (!empty($background_color)) : ?>style="background-color: <?php echo $background_color; ?>;"<?php endif; ?>>
    <div class=" container">
