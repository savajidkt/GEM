            ...
            <form method="post" class="woocommerce-form woocommerce-form-register register" <?php
                ...
                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="email"
                        id="reg_email" autocomplete="email" placeholder="Your email address*"
...
<hr class="line_buttom">
            ...
            <div class="active-account-form">
                ...
                if(!empty($sign_in_text)) { ?>
                 <button class="toggle" data-target="myPopup" onclick="showDiv_sign()"><?php echo $sign_in_text;?></button>
                 <?php } ?>
            </div>
        </div>
        <?php
