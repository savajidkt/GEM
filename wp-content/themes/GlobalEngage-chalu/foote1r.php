   ...
   <div class="container">
         ...
         <div class="footer-menu-content">
            ...
            if(!empty($office_address)) { ?>
                <div class="footer-top-text offices">
                   <h2 class="drop-menu-icon">Our offices</h2>
            ...
            <div class="footer-top-text helpful">
               <h2 class="drop-menu-icon">Helpful Links</h2>
      ...
      <div class="footer-bottom">
         <div class="left-copy-text">
            <h2>© <?php echo date('Y');?> - Global Engage - Site Designed & Developed By <a href="https://cda.group/" target="_blank">CDA</a></h2>
         </div>
